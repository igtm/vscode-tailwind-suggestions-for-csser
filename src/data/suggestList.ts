export const suggestList = {
  ...
  "background-image:linear-gradient(to top right, var(--tw-gradient-stops));": "bg-gradient-to-tr",
  "background-image:linear-gradient(to right, var(--tw-gradient-stops));": "bg-gradient-to-r",
  ...
  "background-image:linear-gradient(to bottom left, var(--tw-gradient-stops));": "bg-gradient-to-bl",
  "background-image:linear-gradient(to left, var(--tw-gradient-stops));": "bg-gradient-to-l",
  "background-image:linear-gradient(to top left, var(--tw-gradient-stops));": "bg-gradient-to-tl",
